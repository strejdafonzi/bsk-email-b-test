<template>
    <button
      v-if="visible"
      @click="scrollToTop"
      class="fixed bottom-8 right-8 flex items-center space-x-2 border-blu-mN color-blu-d btn btn-circle btn-lg hover:bg-base-300">
  ...
  const onScroll = () => {
    ...
    visible.value = scrollPercent > 0.2;
  };
