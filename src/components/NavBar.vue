    ...
    <div class="w-full sm:w-full max-h-fit" id="Navigace">
        <nav class="w-full px-6 py-4 shadow-md bg-base-100">
            <div class="flex items-center justify-between w-full">
                    ...
                    <svg id="BskyEnvelope" class="pointer-events-none inline-block align-middle h-[1.25em] w-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 200">
                        <defs>
                            <linearGradient id="blue-gradient" x1="165.44" y1="29.72" x2="235.08" y2="99.35" gradientUnits="userSpaceOnUse">
                                ...
                                <stop offset=".21" stop-color="#5483ba" />
                                <stop offset=".55" stop-color="#496fa4" />
                                <stop offset=".95" stop-color="#375080" />
                                <stop offset="1" stop-color="#354d7c" />
                            </linearGradient>
                        </defs>
                        <rect fill="#1b1b2e" x="105.95" y="-54.6" width="188.62" height="309.41" rx="24.16" ry="24.16" transform="translate(300.37 -100.15) rotate(90)" />
                        <rect fill="#d3cdbc" x="47.56" y="7.8" width="305.41" height="184.62" rx="22.16" ry="22.16" />
                        <path fill="#c6bfb0" d="M338.33,167.5l-123.86-122.16c-7.82-7.71-20.61-7.71-28.43,0l-123.86,122.16c-4.62,4.56-6.49,10.82-5.64,16.78,3.69,2.75,8.25,4.38,13.18,4.38h261.08c4.93,0,9.49-1.63,13.18-4.38.84-5.96-1.03-12.22-5.65-16.77Z" />
                        <path fill="#273151" d="M60.63,13.51c-1.18,5.88.59,12.21,5.33,16.74l120.47,115.02c7.6,7.26,20.05,7.26,27.65,0l120.47-115.02c4.53-4.32,6.33-10.27,5.47-15.92H60.7c-.04-.27-.04-.55-.07-.82Z" />
                        <path fill="#d3cdbc" d="M65.97,24.58l120.47,115.02c7.6,7.26,20.05,7.26,27.65,0l120.47-115.02c3.16-3.02,4.99-6.83,5.52-10.77H60.44c.53,3.95,2.37,7.76,5.53,10.77Z" />
                ...
                <!-- Hamburger -->
                <div class="sm:hidden">
                    <button @click="open = !open" class="btn btn-ghost btn-circle" aria-label="Toggle Menu">
                ...
                <NavDesktop :t="t" :languages="languages" :currentLanguage="currentLanguage" @language-change="setLanguage" />
            </div>

            <NavMobile v-if="open" :t="t" :languages="languages" :currentLanguage="currentLanguage" @language-change="setLanguage" @close="open = false" />
        </nav>
    </div>
</template>
...
<script setup>
    import { ref } from 'vue';
      ...
      import { useTranslations, languages, currentLanguage, setLanguage } from '@/lang.js';
